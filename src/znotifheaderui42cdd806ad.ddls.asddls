/********** GENERATED on 03/03/2022 at 08:24:13 by CB9980001722**************/
 @OData.entitySet.name: 'NotifHeaderUI' 
 @OData.entityType.name: 'NotifHeaderUIType' 
 define root abstract entity ZNOTIFHEADERUI42CDD806AD { 
 ...
 @OData.property.name: 'to_NotificationHeaderItem' 
//A dummy on-condition is required for associations in abstract entities 
//On-condition is not relevant for runtime 
 _NotificationHeaderItem : association [0..*] to ZNOTIFITEMSFAEAFAAA53 on 1 = 1; 
 } 
